...
#Normalize
dfN=((df_concrete-df_concrete.min())/(df_concrete.max()-df_concrete.min()))*10
print(dfN.head())

dfN.columns = ['cement','slag','ash','water','superplastic','coarseagg','fineagg','age','strength']
y=dfN['strength']
X=dfN.drop(['strength'],axis = 1)
...
sns.pairplot(dfN[cols], size=1.9)
plt.show()
print("=================================================================")
#Heatmap
cm = np.corrcoef(dfN[cols].values.T)
